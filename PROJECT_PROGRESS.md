...
项目用于发布 `Relaycraft` 公开仓库及其 `relay` 技能。当前阶段：README 已完成本地编写和检查，待提交并推送到公开仓库。
...
5. 提交 `README.md` 和本进度更新，推送后重新核对远程 README 链接与工作树状态。

## 最近更新时间与变更记录

- 2026-09-05 Asia/Shanghai：创建进度文件；完成本地作者元数据重写；强制更新远程 `main`；核对远程 17 个提交均使用化名；完成 README 本地检查，待提交推送。
